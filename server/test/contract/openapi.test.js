...
describe('OpenAPI contract', () => {
  ...
  test('documents critical integration-tested endpoints', async () => {
    ...
    const requiredOperations = [
      ...
      ['patch', '/api/admin/last-posts/{lastPostId}/restore'],
      ['patch', '/api/admin/events/{eventId}/hide'],
      ['patch', '/api/admin/events/{eventId}/restore'],
      ['patch', '/api/admin/retirement-messages/{messageId}/hide'],
      ['patch', '/api/admin/retirement-messages/{messageId}/restore'],
      ['patch', '/api/admin/retirement-comments/{commentId}/hide'],
      ['patch', '/api/admin/retirement-comments/{commentId}/restore'],
      ['post', '/api/events'],
